...
element1.addEventListener('click', ()=>{
    element1.innerHTML = "I've been clicked! <br> Try double clicking!"
})

element1.addEventListener('dblclick', ()=>{
    element1.innerHTML = "I've been double clicked! <br> now single click me."
})
...
element2.addEventListener('mouseout', ()=>{
    ...
    element2.style.backgroundColor = "lime"
})
